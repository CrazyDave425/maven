...
<%
if(request.getAttribute("allProvider")==null)
	request.getRequestDispatcher("/provider/getAllProvider").forward(request,response);
%>
<div class="right">
        <div class="location">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${allProvider }" varStatus="status">
				<tr>
					<td>
